...
var changePartnershipCode = function changePartnershipCode(data) {
  ...
  var html = "<option data-tokens=\"all\" value=\"0\" data-id=\"0\">Select Partnership</options>";
  data.forEach(function (d, i) {
    html += "<option data-tokens=\"" + d.name + "\" data-id=\"" + d.id + "\" value=\"" + d.id + "\">" + Object(_util_js__WEBPACK_IMPORTED_MODULE_1__["titleCase"])(d.name) + "</option>";
  });
...
$("#generate-partnership-page").on('click', function () {
  generatePartnershipChart();
});

var generatePartnershipChart = /*#__PURE__*/function () {
  ...
  return function generatePartnershipChart() {
...
$("#generate-report-link").on('click', function () {
  ...
  generatePartnershipChart().then(function (res) {
    ...
    var canvas = charts.getElementsByTagName("canvas");
    var canvasTitles = charts.getElementsByClassName('card-header');
...
var revalidate = function revalidate() {
  ...
  if (now > cachetime || cache_version !== current_version) {
    ...
    localStorage.clear();
    dexie__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]('2scale'); // let tomorrow = moment().add(1, 'days').format("YYYY-MM-DD");
...
/*!******************************!*\
  !*** ./resources/js/util.js ***!
  \******************************/
/*! exports provided: staticText, gradients, titleCase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var staticText = __webpack_require__(/*! ../json/static.json */ "./resources/json/static.json");
var gradients = ["purple", "peach", "blue", "morpheus-den"];
...
module.exports = JSON.parse("{\"countries\":[{\"country\":\"Ethiopia\",\"desc\":\"This country is located in the Horn of Africa at the North East of the continent. It is one of the fastest growing economies in the region.\"},{\"country\":\"Ghana\",\"desc\":\"Country in western Africa, situated along the Gulf of Guinea and the Atlantic Ocean. Considered one of the more stable and leading countries of Africa.\"},{\"country\":\"Cote D'Ivoire\",\"desc\":\"Country located in West Africa. Since 2012 the country's economic growth ranked among the most robust on the African continent.\"},{\"country\":\"Kenya\",\"desc\":\"Situated on Africa's east coast, Kenya has made significant reforms that have driven sustained economic growth and social development over the past decade.\"},{\"country\":\"Mali\",\"desc\":\"Landlocked country in western Africa. Although Mali is one of the largest countries in Africa, is has a relatively small population.\"},{\"country\":\"Nigeria\",\"desc\":\"A key regional player in West Africa, often referred to as the “Giant of Africa”. Nigeria accounts for 47 percent of West Africa’s population.\"},{\"country\":\"Burkina Faso\",\"desc\":\"Landlocked, Francophone country in Western Africa. It is bordering 6 different countries, among which Ghana, Ivory Coast, Mali and Niger.\"},{\"country\":\"Niger\",\"desc\":\"Officially the Republic of the Niger, this landlocked country in West Africa named after the Niger River, is the largest country in West-Africa.\"}]}");
