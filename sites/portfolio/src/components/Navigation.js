    ...
    render() {
        return (
            <Navbar bg="dark" fixed="top" variant="dark" className="NavDark" expand="lg">
                <Container>
                    <Navbar.Brand>
                        <Image src={`${process.env.PUBLIC_URL}/images/logo-akvo.png`} height="38px" />
                    </Navbar.Brand>
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Form inline>
                            <a className="btn btn-secondary text-white" href="https://github.com/akvo/akvo-tech-consultancy" target="_blank" rel="noopener noreferrer">
