...
option = {
    baseOption: {
                ...
                '2006-01-01', '2007-01-01','2008-01-01','2009-01-01','2010-01-01',
                {
                    ...
                    tooltip: {
                        formatter: function (params) {
                            return params.name + 'GDP reaches another height';
                        }
                    },
                    symbol: 'diamond',
                    symbolSize: 18
        ...
        legend: {
            x: 'right',
            data: ['First Industry', 'Second Industry', 'Third Industry', 'GDP', 'Financial', 'Real Estate'],
            selected: {
                'GDP': false, 'Financial': false, 'Real Estate': false
            }
        },
        calculable : true,
        grid: {
...
                    'Yunnan', '\n Tibet', 'Shaanxi', '\n Gansu', 'Qinghai', '\n Ningxia', 'Xinjiang'
        ...
        series: [
            ...
            {name: 'First Industry', type: 'bar'},
            {name: 'Second Industry', type: 'bar'},
            {name: 'Third Industry', type: 'bar'},
            {
                name: 'GDP Proportion',
                type: 'pie',
                center: ['75%', '35%'],
    ...
    options: [
        {
            ...
            series: [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2002sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2002sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2002sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2003sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2003sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2003sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2004sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2004sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2004sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2005sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2005sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2005sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2006sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2006sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2006sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2007sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2007sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2007sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2008sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2008sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2008sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2009sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2009sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2009sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2010sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2010sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2010sum']}
                ]}
            ]
        },
        {
            ...
            series : [
                ...
                {data: [
                    {name: 'First Industry', value: dataMap.dataPI['2011sum']},
                    {name: 'Second Industry', value: dataMap.dataSI['2011sum']},
                    {name: 'Third Industry', value: dataMap.dataTI['2011sum']}
                ]}
            ]
        }
    ]
