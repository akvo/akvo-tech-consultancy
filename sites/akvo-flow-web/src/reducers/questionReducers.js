  ...
  questions = questions.map((x) => {
    ...
    if (x.help) {
      ...
      hasUnit = !notEmpty
        ...
        : false;
      if (notEmpty && !hasUnit) {
        help = x.help.text.includes("##UNIT##")
          ? x.help.text.split("##UNIT##")[0]
          : x.help.text;
        help = help.includes("##MULTICASCADE##")
          ? help.split("##MULTICASCADE##")[0]
          : help;
      }
      ...
      if (x.help.altText) {
        if (Array.isArray(x.help.altText)) {
          ...
          do {
            tooltips = {
              ...tooltips,
              [x.help.altText[hi].language]: x.help.altText[hi].text,
            };
            hi++;
        ...
        if (!Array.isArray(x.help.altText)) {
          tooltips = {
            ...tooltips,
            [x.help.altText.language]: x.help.altText.text,
          };
        }
      }
    }
