...
<div class="form-inline my-2 my-lg-0">
		<form onsubmit="focusTo()">
            ...
            <a href="#" onclick="zoomMap('out')" class="btn btn-light my-2 my-sm-0"><i class="fa fa-search-minus"></i></a>
            <a href="#" onclick="zoomMap('in')" class="btn btn-light my-2 my-sm-0"><i class="fa fa-search-plus"></i></a>
