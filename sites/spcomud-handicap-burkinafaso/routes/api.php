...
Route::get('/maps/config/{form_id}', 'Api\ApiController@getMaps');
Route::get('/maps/data/{form_id}', 'Api\ApiController@getMapsData');
Route::get('/maps/location/{form_id}', 'Api\ApiController@getMapsLocation');
