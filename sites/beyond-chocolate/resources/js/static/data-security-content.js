...
const dsc = {
    en: <Fragment>
            ...
            <p className="text-justify">
                Akvo maintains strong data security and privacy protection policies, frameworks, and procedures, as laid out further in the below text. Data is stored securely; we ensure data is safely encrypted, and your data is never shared with third parties. ​ We comply with the European General Data Protection Regulations (GDPR).
            </p>
            <br/>
            ...
            <ol className="pl-5">
                <li>No only ensure that data are anonymised, but also aggregated and/or averaged before any publication of data.</li>
                <li>Still be careful in sharing anonymised, but also aggregated and/or averaged data and check where any risk of sharing sensitive information exists. In this case, the Members involved will be contacted first.</li>
                <li>Internal reporting to the Members, in a confidential setting, will always precede external reporting.</li>
            </ol>
            <br/>
    ...
    de: <Fragment>
            ...
            <p className="text-justify">
                Akvo hält strenge Richtlinien und Verfahren für Datensicherheit und Datenschutz ein, welche im Folgenden dargestellt werden. Alle Daten werden sicher gespeichert. Wir stellen sicher, dass die Daten sicher verschlüsselt sind und Ihre Daten niemals an Dritte weitergegeben werden. Wir halten uns an die Europäischen Allgemeinen Datenschutzbestimmungen (DSGVO).
            </p>
            <br/>
            ...
            <ol className="pl-5">
                <li>Es wird vor der Veröffentlichung von Daten nicht nur sichergestellt, dass Daten anonymisiert sind, sondern zusätzlich eine Aggregierung oder Durchschnittsbildung  erfahren haben.</li>
                <li>Auch bei anonymisierten Daten und bei Aggregierungen oder Durchschnitten wird Vorsicht walten gelassen und wird überprüft ob ein Risiko bezüglich der Weitergabe sensibler Informationen besteht. In diesem Fall werden die betroffenen Mitglieder vor jedweder Weitergabe kontaktiert.</li>
                <li>Daten werden vor einer externen Veröffentlichung immer zuerst unter vertraulichen Bedingungen intern innerhalb der Mitglieder der Plattformen geteilt.</li>
            </ol>
            <br/>

            <h4>Zustimmung zu und Sichbarkeit der Datensicherheitsvorkehrungen</h4>
            <p className="text-justify">
                Bei der Registrierung werden die NutzerInnen gebeten, der Verarbeitung ihrer Daten gemäß den oben genannten Datensicherheitsvorkehrungen zuzustimmen, indem sie ein entsprechendes Feld anklicken. Der Link zu den Datensicherheitsvorkehrungen wird außerdem jederzeit oberhalb der Fragebögen angezeigt.
            </p>
        </Fragment>
    ,
};
